...
export default function NodePanel() {
  // manually saves to localstorage
    ...
    >
      <div className="bg-gray-200 py-2 mb-4">
        <button
          ...
          className="px-10 font-medium cursor-pointer py-2 rounded-xl border mx-auto block bg-white border-blue-500"
        >
          Save flow
        </button>
      </div>
      <div className="nodes">
        {/* Add new nodetype using NewNode component */}
        <NewNode
